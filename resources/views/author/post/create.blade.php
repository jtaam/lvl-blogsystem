                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea name="post_promo" rows="4" class="form-control no-resize" placeholder="Type posts promo..."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <br>
                            <a href="{{route('author.post.index')}}" type="button" class="btn btn-warning m-t-15 waves-effect">BACK</a>
