...
@push('css')
    <style>
        .sidebar .user-info {
            background: url(http://blogsystem.test/assets/backend/images/author_img_background.jpg) no-repeat no-repeat !important;
        }
    </style>
@endpush
                            ...
                            <form class="form-horizontal" method="post" action="{{route('author.profile.update')}}" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="full_name" class="form-control" placeholder="Jhon Doe" name="name" value="{{Auth::user()->name}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="email" value="{{Auth::user()->email}}" id="email_address_2" class="form-control" placeholder="Enter your email address">
                                            </div>
                                        </div>
                                    </div>
                                </div>
