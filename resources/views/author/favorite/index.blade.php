                                ...
                                @foreach($posts as $key=>$post)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button onclick="removePost({{$post->id}});" class="btn btn-sm btn-danger waves-effect"><i class="material-icons">delete_forever</i></button>
                                            <form id="remove-post-{{$post->id}}" action="{{route('post.favorite',$post->id)}}" method="post" style="display: none;">
                                                @csrf
                                            </form>
                                        </td>
                                    </tr>
