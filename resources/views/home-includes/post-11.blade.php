<div class="single-post post-style-2">
    @if (isset($posts[11]))
        ...
        <div class="blog-info">
            ...
            <h4 class="title"><a
                        href="{{route('post.details', $posts[11]->slug)}}"><b>{{ucwords($posts[11]->title)}}</b></a>
            </h4>
            ...
            <ul class="post-footer">
                <li>@guest
                    ...
                    @endguest</li>
                <li><a href="{{route('post.details',$posts[11]->slug)}}#comments"><i
                                class="ion-chatbubble"></i>{{$posts[11]->comments()->count()}}</a>
                </li>
